...
Tältä sivulta löydät vastaukset Matlua koskeviin useimmin kysyttyihin kysymyksiin. Mikäli et löydä kysymykseesi vastausta tältä sivulta, olethan yhteydessä Matlun hallitukseen tai tiettyyn virkailijaan, joka mahdollisesti voisi auttaa vastauksen löytämisessä!
...
Matlun varsinaisia jäseniä ovat **järjestöt**, välillisiä puolestaan kaikki jäsenjärjestöihin liittyneet opiskelijat. Toimeenpaneva elin on **hallitus**, joka koostuu 8-18 jäsenjärjestöjen jäsenistä. Hallituspaikkoja pyritään jakamaan mahdollisimman laajasti kaikkien tiedekunnan oppiaineiden opiskelijoille. Hallituksen lisäksi toimintaa tukevat myös virkailijat sekä jäsenjärjestöjen aktiivit.
...
Matlu järjestää tapahtumia laidasta laitaan. Vuosittain järjestettäviä tapahtumia on muun muassa vuosijuhlat, Laskuhumala, Kesäbileet, Fuksibileet, tiedekuntasauna. Muita tapahtumia järjestetään virkailijoiden mielenkiinnon ja jäsenistön toiveiden mukaisesti - vain taivas on rajana!

## Miten Matlu eroaa muista Kumpulan järjestöistä?

Suurin ero Matlun ja muiden Kumpulalaisten järjestöjen välillä on se, että Matlun jäseniä ovat järjestöt. Mikäli olet jonkin Matlun alaisen järjestön jäsen, olet sen myötä myös Matlun jäsen. Esimerkiksi poikkikumpulalainen Limes ry eroaa Matlusta muun muassa tältä osin. Matlu on siis Kumpulan ainejärjestöjen kattojärjestö. Matlu on myös tiedekuntajärjestö.

## Miten Matlu voi auttaa jäsenjärjestöjään?

Matlulla on laajat resurssit koko Kumpulan väliseen yhteydenpitoon. Mikäli kohtaat jonkin yliopisto-opiskeluun tai opiskelijoihin liittyvän ongelman, johon et koe voivasi vaikuttaa yksilönä, ota yhteyttä Matluun! Järjestön voima on kaikkien jäsenien käytettävissä ja hallitus auttaa mielellään.
...
## Missä Matlu vaikuttaa?

Matlu vaikuttaa Kumpulassa ja opiskelijahuoneena toimii Onkalo (A118). Matlun paremmin tunnettu tila löytyy Leppäsuonkadulla sijaitsevalta Matlu-klusterilta.

## Kuka on Urho Karhu?

Urho Karhu on Matlu-klusterin maskotti. Tuo suuri, mutta lempeä nalle rakastaa paijaamista ja varovaisia haleja. Urho asuu klusterilla ja valvoo siellä matlulaisten toimintaa.

## Minkä väriset haalarit Matlulla on?

Matlulla ei ole omia haalareita. Tiedekuntajärjestönä Matlu haluaa korostaa poikkitieteellisyyttä ja onhan Kumpulan haalareiden värikirjo jo sellaisenaan vaikuttava!
